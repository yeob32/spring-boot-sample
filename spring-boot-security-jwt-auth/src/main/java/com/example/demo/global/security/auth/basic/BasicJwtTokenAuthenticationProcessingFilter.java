...
public class BasicJwtTokenAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {

    private final AuthenticationFailureHandler authenticationFailureHandler;
    private final TokenExtractor tokenExtractor;

    public BasicJwtTokenAuthenticationProcessingFilter(AuthenticationFailureHandler authenticationFailureHandler,
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        return getAuthenticationManager().authenticate(new BasicJwtAuthenticationToken(token));
    }
